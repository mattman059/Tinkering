...
import requests
url = "https://www.powerball.com/previous-results?gc=powerball&sd=1997-11-01&ed=2023-12-28&pg=13"
code = requests.request("GET", 'https://www.powerball.com/previous-results?gc=powerball&sd=1997-11-01&ed=2023-12-28&pg=13')
x = code.text
...
odd = odd.replace("\nS","&")
odd = odd.replace("\n",",")
odd = odd.replace("&on","Mon")
odd = odd.replace("&ue","Tue")
odd = odd.replace("&ed","Wed")
odd = odd.replace("&hu","Thu")
odd = odd.replace("&ri","Fri")
odd = odd.replace("&at","Sat")
odd = odd.replace("&un","Sun")
odd = odd.replace("Mon","\nMon")
odd = odd.replace("Tue","\nTue")
odd = odd.replace("Wed","\nWed")
odd = odd.replace("Thu","\nThu")
